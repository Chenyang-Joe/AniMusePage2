...
async function loadAnimal(filename, xOffset, yOffset) {
  ...
  // Self-illuminate textured meshes via their albedo so dark animals (panda
  // black, hippo, wolf) don't get crushed under the white-bg key+fill lighting.
  // Matches the scene_teaser / scene_1 pattern: emissive = albedo texture, low
  // intensity, so highlights stay clean and shadows lift.
