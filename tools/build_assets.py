...
# camelid, most of a ton of buffalo -- and a bird, which is the one
...
CORRESPOND = [
    ...
    ("camel",     "stage1/s002_Bactrian_Camel_Juvenile_fighttauntreact/blob_nopiles.glb",      "Bactrian Camel",   -165),
